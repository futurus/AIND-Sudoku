...
def get_twins(twins, values):
    """Helper function for naked_twins
    Args:
        twins(array): find the twin value from 'twins' boxes (members of the same unit) in values
...
def naked_twins(values):
    ...
    # Find all instances of naked twins
        ...
        twinVals = get_twins(twins, values)

    # Eliminate the naked twins as possibilities for their peers
        if twinVals != '':
            for digit in twinVals:
                for box in unit:
                    if values[box] != twinVals:
